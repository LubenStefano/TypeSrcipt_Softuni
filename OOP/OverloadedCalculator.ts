class Calculator{
    ...
    calculate(method: "power" | "log" | "add" | "subtract" | "multiply" | "divide", a:number, b?:number, c?:number, d?:number):number{
        let result:number = 0;
        ...
        switch(method) {
            ...
            case "divide":
            result = a;
            if (b !== undefined && b !== 0) result /= b;
            if (c !== undefined && c !== 0) result /= c;
            if (d !== undefined && d !== 0) result /= d;
            break;
        }
